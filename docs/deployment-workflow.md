...
4. Commit and push to GitHub:
   ...
   ```
5. Let the production Vercel project deploy from the GitHub push.
...
- The production Vercel project for the public domain is owned outside the local Viron's projects link; treat the GitHub push as the source of truth for production deployment.
