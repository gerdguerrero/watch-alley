...
export function EntrancePreloader() {
  ...
  useGSAP(
    () => {
      ...
      const leftLeg = document.getElementById("preload-left-leg");
      const rightLeg = document.getElementById("preload-right-leg");
      ...
      <div className="relative w-full max-w-[450px] aspect-[490/365] p-6 flex items-center justify-center">
        ...
        >
          <g id="preload-logo">
            ...
            <g id="preload-watch-w" fill="#FFFFFF">
            ...
            <g id="preload-watch-tch" fill="#FFFFFF">
