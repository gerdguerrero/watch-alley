...
export function EntrancePreloader() {
  ...
  useGSAP(
    () => {
      ...
      // 4. Sequential windshield-wipe text reveals following the hand movement
      tl.fromTo(
        "#preload-the",
        { clipPath: "inset(0 100% 0 0)" },
    ...
    >
      <div className="relative w-full max-w-[450px] aspect-[490/365] p-6 flex items-center justify-center">
        ...
        >
          <g id="preload-logo">
            {/* THE wordmark */}
            <g id="preload-the" fill="#BD9A32" style={{ willChange: "clip-path" }}>
            ...
            <g id="preload-watch-w" fill="#FFFFFF" style={{ willChange: "clip-path" }}>
            ...
            <g id="preload-watch-tch" fill="#FFFFFF" style={{ willChange: "clip-path" }}>
