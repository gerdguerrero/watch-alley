...
function MagazineMasthead({ issue, count }: { issue: string; count: number }) {
  return (
    <div className="relative mb-[clamp(20px,3vw,40px)] flex flex-wrap items-end justify-between gap-4 pb-[clamp(16px,2vw,24px)]">
      <span className="wa-rev-rise font-mono text-[10px] uppercase tracking-[0.28em] text-[color:var(--color-cream-60)]" style={{ transitionDelay: "300ms" }}>
        The Watch Alley Journal · {issue}
      </span>
      <span className="wa-rev-rise font-mono text-[10px] uppercase tracking-[0.28em] text-[color:var(--color-cream-60)] [font-variant-numeric:tabular-nums]" style={{ transitionDelay: "400ms" }}>
  ...
  return (
    ...
    >
      ...
      <header className="mb-10 flex flex-wrap items-end justify-between gap-6">
        <div className="wa-rev-rise flex items-end gap-[clamp(16px,3vw,40px)]" style={{ transitionDelay: "100ms" }}>
          <BigNum>02</BigNum>
