  ...
  return (
    <div className="min-h-screen bg-[#0e0f11] text-white flex flex-row">
      ...
      <div className="flex-1 flex justify-center items-center p-8 bg-[#070708] overflow-auto select-none">
        ...
        {styleId === 1 && (
          <div className="w-[1080px] h-[1350px] bg-[#121315] flex flex-col justify-between items-center p-[70px] relative select-none shrink-0" id="poster-canvas">
            ...
            <div className="w-[960px] h-[640px] flex relative bg-[#f7f6f2] rounded shadow-[0_40px_90px_-15px_rgba(0,0,0,0.95)] overflow-hidden scale-[1.05] mt-[240px]">
              ...
              <div className="w-[480px] h-full p-[45px] flex flex-col justify-between border-r border-black/5 relative z-2">
                <div>
                  <div className="flex justify-between items-center border-b-2 border-[#18191a] pb-2 mb-5">
                    <span className="text-[10px] font-black tracking-widest text-[#c39a48] uppercase">Analysis // Discovery</span>
                    <img src="/social/vibe-coders-logo-black.png" className="h-[18px] object-contain" alt="Vibe Coders PH" />
                  </div>
                  <div className="mb-4">
                    <span className="text-[14px] font-black tracking-wide uppercase text-[#18191a] block mb-1">CASE STUDY</span>
                    <h1 className="font-sans font-black text-[52px] leading-[0.88] tracking-tighter text-[#18191a] uppercase">
                      {headline.replace(".", "").split(" ").slice(0, 2).join(" ")}<br />
                  ...
                  <div className="flex gap-[20px] font-serif text-[11px] leading-[1.5] text-[#18191a] text-justify">
                    <div className="flex-1">
                      <span className="float-left font-sans text-[38px] leading-[0.8] font-black pr-2 pt-1 text-[#18191a]">I</span>
                      t was discovered during a standard pair-programming session for product startup <strong>{project}</strong>. When presented with a raw, layered <code>.ai</code> logo file, instead of failing or throwing an unsupported extension error, the AI model inspected the file headers.
                    </div>
                    <div className="flex-1">
                      By utilizing a simple command-line binary (<code>pdftoppm</code>), the agent was able to extract the high-resolution vector layout into a readable raster image, feed it back into its own multimodal vision network, and fully reconstruct the designer's intent natively.
                    </div>
                  </div>
                </div>
              ...
              <div className="w-[480px] h-full p-[45px] flex flex-col justify-between bg-[#fafdff] relative z-2">
                <div>
                  <div className="flex justify-between items-center border-b-2 border-[#18191a] pb-2 mb-5">
                    <span className="text-[10px] font-black tracking-widest text-[#18191a] uppercase">Visual Evidence</span>
                    <span className="text-[9px] font-bold text-[#5e6268] tracking-wider">FIG. 1.0</span>
                  </div>
                  <div className="w-full h-[280px] border border-black/15 bg-[#090806] p-4 flex items-center justify-center shadow-inner mb-4">
                    <img src="/social/watch-alley-logo-preview.png" className="max-w-full max-h-full object-contain" alt="THE WATCH ALLEY" />
                  </div>
                  <div className="text-[10px] leading-[1.45] text-[#5e6268] border-left-2 border-[#18191a] pl-[10px] mb-[10px]">
                    <strong className="text-[#18191a] font-bold text-[9px] tracking-wider uppercase block mb-1">Figure 1.0: Layer Extraction</strong>
                    Rasterized preview of the raw vector logo files recovered natively from the Illustrator file structure.
                  </div>
                  <div className="bg-[#1a1c1e] text-[#eaecef] rounded p-3 font-mono text-[9px] leading-[1.4] border-l-[3px] border-[#c39a48] shadow-md">
                    <div><span>$</span> file {project.replace(/\s+/g, "_")}_LOGOS.ai</div>
        ...
        {styleId === 2 && (
          <div className="w-[1080px] h-[1350px] bg-[#0f0c1b] flex flex-col justify-between items-center p-[60px] relative select-none shrink-0" id="poster-canvas">
            ...
            <header className="w-full flex justify-between items-center border-b border-white/8 pb-5 z-10">
              <div className="flex items-center gap-3">
                <img src="/social/vibe-coders-logo-white.png" className="h-[26px] object-contain" alt="Vibe Coders PH" />
                <div className="font-mono text-[12px] tracking-[0.2em] text-[#a0aec0] uppercase ml-2">Bypassing Proprietary Walls</div>
              </div>
            ...
            <div className="w-full flex gap-10 flex-1 mb-[30px] items-stretch z-10">
              ...
              <div className="flex-1 flex flex-col gap-5 justify-center">
                <div className="bg-white/3 border border-white/8 rounded-2xl p-6 flex gap-5 items-start relative overflow-hidden backdrop-blur-md shadow-2xl">
                  <div className="text-[32px] font-black font-mono leading-none bg-gradient-to-br from-[#00f2fe] to-[#9d4edd] bg-clip-text text-transparent">01</div>
                  <div>
                    <h3 className="text-[18px] font-bold uppercase tracking-wider mb-[6px]">The Carrier (.ai)</h3>
                    <p className="text-[13px] leading-[1.5] text-[#a0aec0]">
                      Modern Adobe Illustrator files compile with an embedded, Acrobat-compliant PDF stream (version 1.6) by default. The proprietary vector data contains a hidden standard document structure.
                    </p>
                  </div>
                </div>

                <div className="bg-white/3 border border-white/8 rounded-2xl p-6 flex gap-5 items-start relative overflow-hidden backdrop-blur-md shadow-2xl">
                  <div className="text-[32px] font-black font-mono leading-none bg-gradient-to-br from-[#00f2fe] to-[#9d4edd] bg-clip-text text-transparent">02</div>
                  <div>
                    <h3 className="text-[18px] font-bold uppercase tracking-wider mb-[6px]">The Extraction (pdftoppm)</h3>
                    <p className="text-[13px] leading-[1.5] text-[#a0aec0]">
                      Instead of manually exporting, coding agents execute a system command (<code>pdftoppm</code>) directly on the raw file path. This extracts and rasterizes the vector viewport into a crisp PNG layer.
                    </p>
                  </div>
                </div>

                <div className="bg-white/3 border border-white/8 rounded-2xl p-6 flex gap-5 items-start relative overflow-hidden backdrop-blur-md shadow-2xl">
                  <div className="text-[32px] font-black font-mono leading-none bg-gradient-to-br from-[#00f2fe] to-[#9d4edd] bg-clip-text text-transparent">03</div>
                  <div>
                    <h3 className="text-[18px] font-bold uppercase tracking-wider mb-[6px]">The Cognition (LLM Vision)</h3>
                    <p className="text-[13px] leading-[1.5] text-[#a0aec0]">
                      The coding agent passes the rendered layer into its multimodal vision network, natively inspecting geometries, typographic details, and color palettes—fully bridging design to code instantly.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="w-[430px] bg-white/3 border border-white/8 rounded-3xl p-[30px] flex flex-col justify-between items-center backdrop-blur-md shadow-2xl">
                ...
                <div className="w-full h-[260px] bg-white/2 border border-white/5 rounded-2xl flex items-center justify-center p-[15px] my-[25px] shadow-inner relative overflow-hidden">
                  <img src="/social/watch-alley-logo-preview.png" className="max-w-full max-h-full object-contain z-2" alt="Watch Alley Blueprint" />
                </div>

                <div className="w-full bg-[#090a0f] border border-white/5 rounded-xl p-[18px] font-mono text-[11px] leading-[1.5]">
                  <div><span className="text-[#00f2fe]">$</span> file {project.replace(/\s+/g, "_")}_LOGOS.ai</div>
                  <div className="text-[#ffbe0b]">&gt; PDF document, version 1.6, 1 pages</div>
                  <div className="mt-2"><span className="text-[#00f2fe]">$</span> pdftoppm -png -r 150 ...</div>
            ...
            <footer className="w-full flex justify-between items-center border-t border-white/8 pt-5 z-10">
              <div>
                <span className="text-[11px] font-bold text-white/50 uppercase tracking-widest mr-1">By</span>
                <span className="text-[11px] font-bold text-[#00f2fe] uppercase tracking-wider">{author}</span>
              </div>
        ...
        {styleId === 3 && (
          <div className="w-[1080px] h-[1350px] bg-gradient-to-br from-[#d6e2e9] to-[#f0ebf4] flex flex-col justify-between items-center p-[70px] relative select-none shrink-0" id="poster-canvas">
            {/* Background 3D blobs */}
            ...
            <header className="w-full flex justify-between items-center z-10">
              <img src="/social/vibe-coders-logo-white.png" className="h-[32px] object-contain filter brightness-50" alt="Vibe Coders" />
            ...
            <div className="text-center z-10 mt-5 mb-6">
              <span className="text-[14px] font-bold text-[#7b2cbf] tracking-[0.25em] uppercase block mb-2">A Toy Story Experiment</span>
              <h1 className="font-sans font-black text-[78px] leading-[0.95] tracking-tighter uppercase text-[#2f3e46]">
                {headline.replace(".", "").split(" ").slice(0, 3).join(" ")}{" "}
                <span className="text-[#9d4edd]">{headline.replace(".", "").split(" ").slice(3).join(" ")}</span>
              </h1>
            </div>
            ...
            <div className="w-full flex justify-center items-center gap-12 flex-1 z-10">
              ...
              <div className="w-[490px] h-[520px] bg-[#eae6df] border-[12px] border-[#d5bdaf] rounded-[44px] p-[30px] flex flex-col justify-between items-center shadow-[15px_15px_35px_rgba(0,0,0,0.12),inset_6px_6px_12px_rgba(255,255,255,0.8),inset_-6px_-6px_12px_rgba(0,0,0,0.04)] relative">
                <div className="w-full h-[380px] bg-[#1a1816] rounded-[24px] shadow-[inset_5px_5px_15px_rgba(0,0,0,0.08),0_4px_10px_rgba(255,255,255,0.9)] flex items-center justify-center p-5">
                  <img src="/social/watch-alley-logo-preview.png" className="max-w-full max-h-[250px] object-contain" alt="Watch Alley Logos" />
                </div>
                <div className="w-full flex justify-between items-center text-[11px] font-bold text-[#7b6d61] font-mono mt-3">
                  ...
                  <span className="bg-[#ffe5ec] text-[#ff007f] px-[10px] py-1 rounded-full text-[9px]">LIVE_PREVIEW</span>
              ...
              <div className="w-[390px] h-[500px] bg-[#e8dbfc] rounded-[36px] p-[30px] flex flex-col justify-between shadow-[15px_15px_35px_rgba(0,0,0,0.12),inset_6px_6px_12px_rgba(255,255,255,0.8),inset_-6px_-6px_12px_rgba(0,0,0,0.04)] relative">
                ...
                <div className="my-6">
                  <h2 className="text-[26px] font-black text-[#2f3e46] leading-[1.1] mb-3">No more manual exports! ⚡</h2>
                  <p className="text-[14px] leading-[1.5] text-[#52606d] font-semibold mb-3">
                    During a pair-programming session for <strong>{project}</strong>, we handed the raw <span className="bg-white rounded-lg px-[6px] py-[2px] font-mono text-[11px] text-[#9d4edd] shadow-inner">.ai</span> path directly to the AI agent. It automatically read the hidden PDF layer and parsed the vector paths in seconds.
                  </p>
                ...
                <div className="flex gap-2 font-bold text-[11px]">
                  <div className="bg-white rounded-full px-[14px] py-[6px] text-[#40916c]">#VectorDev</div>
                  <div className="bg-white rounded-full px-[14px] py-[6px] text-[#7209b7]">#Claymorphism</div>
                  <div className="bg-white rounded-full px-[14px] py-[6px] text-[#ffb703]">#{project.replace(/\s+/g, "")}</div>
                </div>
              </div>
            </div>
              ...
              <div className="flex-1 flex flex-col justify-between h-full">
                <div>
                  ...
                  <p className="text-[17px] leading-[1.7] text-white/70 text-justify mb-[30px]">
                    During an active build sprint for product startup{" "}
                    <strong>{project}</strong>, we successfully demonstrated that
                    modern LLM coding agents can natively read, render, and
                    catalog raw Adobe Illustrator (<code>.ai</code>) documents
                    directly. Modern vector design files compile with a hidden,
                    Acrobat-compliant PDF stream (version 1.6) by default. The
                    agent identified this structure, executed a headless
                    extraction, and parsed the geometries without manual exports.
                  </p>
                </div>
                <div
                ...
                >
                  <div>
                    <span className="text-[#d946ef]">$</span> file{" "}
                    {project.replace(/\s+/g, "_")}_LOGOS.ai
                  </div>
                  ...
                  <div className="text-white/95">
                    &gt; Layer extracted. Rendering canvas...
                  </div>
                </div>
              </div>
        ...
        {styleId === 5 && (
          <div className="w-[1080px] h-[1350px] bg-[#1c2321] flex flex-col justify-between items-center px-20 py-[70px] relative select-none shrink-0" id="poster-canvas" style={{ fontFamily: "'Architects Daughter', cursive" }}>
            {/* Spot light overlay */}
            ...
            <div className="text-center z-10 mt-5 mb-[30px]">
              <span className="text-[18px] text-[#f4e285] tracking-[0.2em] uppercase block mb-[10px]">How an AI agent parsed Illustrator blueprints</span>
              <h1 className="text-[84px] font-bold leading-none text-white text-shadow-chalk">
                {headline.replace(".", "").split(" ").slice(0, 3).join(" ")}{" "}
                <span className="text-[#f4e285]">{headline.replace(".", "").split(" ").slice(3).join(" ")}</span>
              </h1>
            </div>
            ...
            <div className="w-full flex-1 flex gap-[50px] mb-[30px] items-center z-10">
              ...
              <div className="flex-[1.1] h-full border border-dashed border-white/15 rounded-2xl p-[30px] flex flex-col justify-between relative">
                ...
                <div className="w-full h-[250px] relative border border-dashed border-white/5 my-[15px]">
                  ...
                  <div className="absolute top-[5px] left-5 text-[12px] leading-tight text-[#fbc4ab]">Golden Compass Leg<br />pointing down ↙</div>
                  <div className="absolute top-[110px] right-[15px] text-[12px] leading-tight text-[#a8dadc]">← Vector Anchor<br />& Bezier Handles!</div>
                  <div className="absolute bottom-[10px] left-[120px] text-[12px] leading-tight text-[#fbc4ab]">Pen nib styled as letter &quot;A&quot; ✒</div>

                  <div className="absolute top-[30px] left-[80px] text-[16px] text-white/20">⤡</div>
                  <div className="absolute top-[100px] right-[80px] text-[16px] text-white/20">⤢</div>
                  <div className="absolute bottom-[30px] left-[160px] text-[16px] text-white/20">⤓</div>
                </div>

                <div className="text-[14px] leading-[1.5] text-white/75 border-t border-dashed border-white/10 pt-[15px]">
                  During a coding session on <strong>{project}</strong>, we bypassed Illustrator's proprietary walls. Since Illustrator compiles with an Acrobat-compliant PDF 1.6 stream by default, we ran a simple command (<code>pdftoppm</code>) to rasterize and inspect the vector paths natively. It worked flawlessly!
                </div>
              </div>
              ...
              <div className="flex-[0.9] flex flex-col items-center justify-center relative">
                ...
                <div className="w-full bg-white p-6 shadow-[0_15px_40px_rgba(0,0,0,0.45),0_4px_10px_rgba(0,0,0,0.2)] rounded-[2px] -rotate-[1.5deg] flex flex-col items-center mb-[70px]">
                  ...
                  <div className="w-full h-[230px] border border-white/5 bg-[#121615] flex items-center justify-center p-[10px] mb-[15px]">
                    <img src="/social/watch-alley-logo-preview.png" className="max-w-full max-h-full object-contain" alt="Rendered logo proof" />
                  </div>
                  <div className="text-[11px] leading-[1.4] text-[#4a4a4a] border-l-2 border-[#1c2321] pl-[10px] w-full">
                    ...
                    The actual printed logo variations recovered directly from the raw Illustrator vector path layers.
                  </div>
                </div>
              </div>
            </div>
            ...
            <footer className="w-full flex justify-between items-center border-t border-dashed border-white/10 pt-[20px] text-[18px]">
              ...
              <div className="text-[#a8dadc]">PROJECT // {project}</div>
            </footer>
          </div>
        )}
